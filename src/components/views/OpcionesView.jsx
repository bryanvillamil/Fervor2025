        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          ...
          >
            <CardContent className="p-8 text-center h-full flex flex-col justify-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Dios me Tocó</h3>
              <p className="text-purple-200 text-lg mb-6">
                Comparte tu testimonio de cómo Dios obró en tu vida durante el evento
              </p>
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          ...
          >
            <CardContent className="p-8 text-center h-full flex flex-col justify-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Deseo Acompañamiento</h3>
              <p className="text-purple-200 text-lg mb-6">
                Solicita acompañamiento espiritual, oración o consejería pastoral
              </p>
